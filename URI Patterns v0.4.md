...
| **Data Item URI**<br />(for data items within datasets) | **`{prefix}/data{/dataset*}[/{concept}/{key}]*`** | **Version 1.0 examples**<br />http://environment.data.gov.uk/data/bathing-water-quality/compliance/point/03600/year/2012<br />
